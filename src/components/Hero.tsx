  ...
  return (
    <section className="min-h-screen bg-transparent text-[#EEEEEE] flex items-center justify-center px-2 sm:px-4 relative">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            <a
              href="https://github.com/Yash-xoxo/yash-search/blob/main/assets/resume/resumeyash.pdf"
              target="_blank"
            ...
            <button
              className="border border-[#00ADB5] text-[#00ADB5] hover:bg-[#00ADB5] hover:text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 flex items-center gap-2 btn-hover text-sm sm:text-base"
        ...
        <div className="flex flex-col items-center justify-center relative mt-8 lg:mt-0">
          ...
          <div className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 w-6 h-6 sm:w-10 h-10 bg-[#00ADB5]/20 rounded-full animate-pulse" />
          <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 w-5 h-5 sm:w-8 h-8 bg-[#00ADB5]/10 rounded-full animate-pulse delay-1000" />
        </div>
      </div>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 bottom-4 sm:bottom-8 flex flex-col items-center z-10 select-none">
        ...
        <ChevronDown className="w-6 h-6 sm:w-8 h-8 text-[#00ADB5] animate-bounce" />
      </div>
    </section>
  );
};
